...
class InitAppInfo {
  ...
  setAppInfo(hostName,AppNum){
      ...
      // 配置 服务器地址
      window.APP_INFO.host = hostIP ;
      // 版本
      window.APP_INFO.version = AppNum ;
  }
  ...
  setAndroidOrIos(){
    ...
    if (isAndroid) {
      //这个是安卓操作系统
      return window.APP_INFO.sysInfo = 'Android';
    }else if(isIOS) {
      //这个是ios操作系统
      return window.APP_INFO.sysInfo =  'IOS';
    }else {
      return window.APP_INFO.sysInfo = 'Other';
    }
  }
